...
dir_roi = 'C:\Users\heard.49\Documents\MATLAB\fmri\isss_multiband_preprocessed_batch_03\rois\HO_atlas';
cd(dir_roi);
files_roi = dir('*.nii');
...
dir_docs = 'C:\Users\heard.49\Documents\MATLAB\fmri\isss_multi_docs\11subj_nowrong_beta_plot_HOatlas';
...
Region = {'Left IFG pars Op', 'Left IFG pars Tri', 'Left IFG pars Op and Tri', 'Left pSTG'};
...
%         label_x{1} = 0;
        ...
        cd(dir_docs);
         ...
         %save in svg format 
         saveas(gcf,['beta_plot_harvardoxford_' name_file], 'png');
