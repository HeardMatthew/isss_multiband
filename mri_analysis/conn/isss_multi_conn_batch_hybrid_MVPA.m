...
ss = 1; % HYBRID
conn_batch = 'conn_hybrid_physio.mat'; % just borrow this to load ROI info
conn_name = 'conn_hybrid_physio_MVPA'; 
scan = study.scan(ss);
...
if create_reg
    ...
    for ii = 1:length(subj) 
        ...
        dir_func_MVPA = fullfile(dir_subj, 'FUNC_MVPA'); % location may change
